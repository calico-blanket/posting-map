...
- **メモ機能**: 「チラシお断りの家あり」「100枚配布済。残40枚」などのメモを記録できます。
...
4. **写真登録**: 画面右下のカメラアイコンから、その場所の写真アップロードして地図上にピン留めできます。（撮影はできません。）
...
詳細な知識がなくても、以下の「Deploy」ボタンから自分専用のアプリをインターネット上に公開できます。
